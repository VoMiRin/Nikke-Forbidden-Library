...
export const ArchiveBoxIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5M10.5 11.25h3M10.5 14.25h3m-6.938 3h12.876c.621 0 1.125-.504 1.125-1.125V7.5h-15v9.625c0 .621.504 1.125 1.125 1.125Z" />
...
export const PuzzlePieceIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.083A12.034 12.034 0 0 1 15.683 4.5H19.5a2.25 2.25 0 0 1 2.25 2.25v3.817c0 .452-.182.887-.49 1.218L18 15.75M14.25 6.083c-.397-.04-.798-.066-1.208-.076A13.453 13.453 0 0 0 4.5 9.75V15a2.25 2.25 0 0 0 2.25 2.25h.75a2.25 2.25 0 0 0 2.25-2.25V12a2.25 2.25 0 0 0-2.25-2.25H6M14.25 6.083v2.167M14.25 18.75v-2.167c0-.452.182-.887.49-1.218L18 12M4.5 19.5V9.75M7.5 19.5h1.5M11.25 19.5h1.5m3.75-3.75V12m0 0H12M12 12v3.75m0 0h3.75m0 0V12m0-3.75V4.5m0 3.75H8.25m0 0V4.5m0 3.75H12" />
  </svg>
);
